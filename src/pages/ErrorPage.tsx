  ...
  return (
    <div className='p-8 h-screen w-screen flex items-center justify-center'>
      <div className='flex items-center max-sm:flex-col'>
        ...
        />
        <div>
          <p className='mb-2 text-4xl max-sm:text-3xl max-[400px]:text-xl font-semibold'>
            Ups! The page was not found.
          </p>
          ...
          <NavLink to={logged ? '/projects' : '/'}>
            <button className='ml-auto block mt-4 px-3 py-1 bg-teal-200 hover:bg-teal-300 shadow-[3px_3px_0_0] shadow-zinc-800 hover:translate-x-0.5 hover:translate-y-0.5'>
              {logged ? 'Go to the dashboard' : 'Go to login page'}
            </button>
          </NavLink>
        </div>
      </div>
