    ...
    return (
        <div className="p-8 h-screen w-screen flex items-center justify-center">
            <div className="flex items-center max-sm:flex-col">
                ...
                />
                <div>
                    <p className="mb-2 text-4xl max-sm:text-3xl max-[400px]:text-xl font-semibold">Ups! There was an error:</p>
                    <p className="text-xl max-[400px]:text-sm text-right">{(error as Error).message}</p>
