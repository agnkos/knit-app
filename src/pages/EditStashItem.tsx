...
export async function action({ params, request }: any): Promise<
  | Response
  | {
      error: any;
    }
...
const EditStashItem = () => {
  ...
  const uploadImage = async (id: string) => {
    ...
    try {
      await uploadBytes(imageFolderRef, imageUpload).then((snapshot) => {
            ...
            <>
                ...
                <div className='p-4 sm:flex sm:gap-6 sm:items-start'>
                  ...
                  <div className='max-w-[500px] sm:grow me-2'>
                    ...
                    <div className='flex gap-4 items-center justify-end'>
                      ...
                      <button className='block px-3 py-1 bg-teal-200  hover:bg-teal-300 shadow-[3px_3px_0_0] shadow-zinc-800 hover:translate-x-0.5 hover:translate-y-0.5'>
                        Save
                      </button>
                    </div>
                  </div>
              ...
              {deleteModal && (
                <DeleteModal
                  ...
                  deleteItem={() =>
                    deleteStashItem(item.stashItemId, item.imageUrl)
                  }
                  item='yarn'
                />
              )}
