    ...
    <div className='flex flex-col justify-center items-center gap-4 h-screen bg-teal-50'>
      ...
      >
        ...
        <input
          ...
          className='px-3 py-1'
        />
        {data?.error === 'Firebase: Error (auth/user-not-found).' && (
          <pre className='text-red-600'>wrong user</pre>
        )}
        <input
          name='password'
          type='password'
          ...
          className='px-3 py-1'
        />
        {data?.error === 'Firebase: Error (auth/wrong-password).' && (
          <pre className='text-red-600'>wrong password</pre>
        )}
        ...
        <p className='text-sm'>
          ...
          <NavLink to='/signup' className='text-teal-500 hover:text-teal-700'>
            {' '}
            sign up.
          </NavLink>
        </p>
