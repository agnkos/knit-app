    ...
    return (
        <div className="mb-4 flex gap-2 items-start max-w-sm" >
            <div className="flex items-center gap-1">
                <ArrowUpCircleIcon className="w-5 h-5 text-zinc-800 cursor-pointer  hover:text-teal-600 transition-colors duration-300"
                    onClick={() => changePosition(item.queuedItemId, item.position, "up")}
                />
                <p className="px-2 border">{index + 1}</p>
                <ArrowDownCircleIcon className="w-5 h-5 text-zinc-800 cursor-pointer  hover:text-teal-600 transition-colors duration-300"
            ...
            <div className="w-full">
                <div className="flex items-center">
                    ...
                    <Link to="add" className="ml-auto" state={{ button: "edit", item: item }}>
                        <PencilIcon
                            className="w-4 h-4 cursor-pointer  hover:text-teal-600 transition-colors duration-300" />
                    </Link>
                    <TrashIcon
